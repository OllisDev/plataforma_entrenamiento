function eliminarBloque(bloqueId, boton) {
    if (!confirm("¿Quieres eliminar este bloque de entrenamiento?")) return;

    let url = `/bloque/${bloqueId}/eliminar`;
    ...
    fetch(url, {
        ...
        .then((data) => {
            ...
            if (data.success) {
                ...
                alert("Error al eliminar el bloque de entrenamiento.");
            }
        })
        .catch((error) => {
            console.log(error);
